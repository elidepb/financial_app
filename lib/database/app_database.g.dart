...
class $CategoriesTable extends Categories
  ...
  @override
  late final GeneratedColumn<String> icon =
...
class Category extends DataClass implements Insertable<Category> {
  ...
  @override
  int get hashCode => Object.hash(id, name, icon, color, type, displayOrder,
...
final class $$CategoriesTableReferences
  ...
  static MultiTypedResultKey<$MovementsTable, List<Movement>>
      _movementsRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
          db.movements,
          aliasName:
              $_aliasNameGenerator(db.categories.id, db.movements.categoryId));

  $$MovementsTableProcessedTableManager get movementsRefs {
    final manager = $$MovementsTableTableManager($_db, $_db.movements)
                ...
                return [
                  if (movementsRefs)
                    await $_getPrefetchedData<Category, $CategoriesTable,
                        ...
                        currentTable: table,
                        referencedTable:
                            $$CategoriesTableReferences._movementsRefsTable(db),
              ...
              addJoins: <
                ...
                if (categoryId) {
                  state = state.withJoin(
                    ...
                    referencedTable:
                        $$MovementsTableReferences._categoryIdTable(db),
                    referencedColumn:
                        $$MovementsTableReferences._categoryIdTable(db).id,
                  ) as T;
                }
